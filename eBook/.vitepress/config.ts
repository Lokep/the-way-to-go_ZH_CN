    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "14.7 新旧模型对比：任务和 worker", link: "/14.7" },
          ...
          { text: "14.16 对 Go 协程进行基准测试", link: "/14.16" },
      ...
      },
      {
        text: "第二十章",
        items: [
          { text: "20.0 Google App Engine 中的 Go", link: "/20.0" },
          ...
          {
            text: "routing-table: routing of different urls to different types of handlers",
            link: "/20.4",
          },
